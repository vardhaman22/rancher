...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/krunalhinguu/kontainer-driver-metadata/rancher-1.29/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
