...
func Test_gitDir(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			"namespace", "name", "https://github.com/vardhaman22/rancher-charts",
			"management-state/git-repo/namespace/name/790b09d7ceabeb33db850bce8b60aaa7d45c6bf0b111620f0a7859c96c4bdcda",
		},
