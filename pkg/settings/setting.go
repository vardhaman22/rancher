...
var (
	...
	MachineProvisionImage               = NewSetting("machine-provision-image", "rancher/machine:v0.15.0-rancher110")
	...
	UIDashboardIndex = NewSetting("ui-dashboard-index", "https://releases.rancher.com/dashboard/release-2.8/index.html")
...
func getMetadataConfig() string {
	data := map[string]interface{}{
		"url":                      "https://raw.githubusercontent.com/vardhaman22/rancher-kontainer-driver-metadata/test-etcd-cert/data/data.json",
