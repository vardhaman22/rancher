...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/vardhaman22/rancher-kontainer-driver-metadata/k8s-130/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
